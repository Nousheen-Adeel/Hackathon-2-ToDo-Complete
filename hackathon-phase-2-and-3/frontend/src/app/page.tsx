...
export default function Dashboard() {
  ...
  const { user, isAuthenticated, loading: authLoading, logout, getAuthHeaders } = useAuth();
  ...
  const handleAddSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Error is already set in addTask, just prevent modal from closing
      ...
      <div className="min-h-screen bg-[#0B0E14] flex">
        ...
        <div className="w-64 bg-[#05070A] min-h-screen p-4 hidden md:block border-r border-white/10">
          ...
          <div className="space-y-2">
            <div className="bg-blue-600 text-white p-3 rounded-lg flex items-center cursor-pointer">
    ...
    <div className="min-h-screen bg-[#0B0E14] flex">
      ...
      >
        ...
        <div className="mt-auto pt-4 border-t border-white/10">
          <div className="flex items-center p-3 text-gray-300">
          ...
          <button
            ...
            className="w-full mt-2 p-3 text-red-400 hover:bg-red-500/20 rounded-lg flex items-center transition-all duration-200"
          >
      ...
      {showAiPanel && (
        <div className="fixed right-6 bottom-20 z-50 transform transition-all duration-300 ease-in-out animate-in slide-in-from-bottom-4">
          <div className="bg-[#1A1F26] backdrop-blur-sm border border-blue-500/30 rounded-xl shadow-xl w-96 h-[576px] flex flex-col">
